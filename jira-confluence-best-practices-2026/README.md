# 🚀 Atlassian: Jira e Confluence Best Practices 2026

> Corso di formazione online — 20 ore (5 sessioni da 4h ciascuna)

## Informazioni generali

| Campo | Dettaglio |
|-------|-----------|
| **Azienda** | [Tyvak International](https://tyvak.eu) — Settore aerospaziale |
| **Piattaforma** | Jira Cloud + Confluence Cloud |
| **Lingua** | Italiano |
| **Durata** | 20 ore totali (5 sessioni × 4h, pause da 10 min incluse) |
| **Modalità** | Online (videoconferenza) |
| **Focus principale** | Jira Cloud (con modulo Confluence nella sessione 5) |
| **Livello** | Da basi strutturate → utente proficiente + amministrazione base |
...
I 4 partecipanti dovranno passare da un uso quotidiano non strutturato a un utilizzo **proficiente e consapevole** di Jira, ed essere in grado di **trasferire le competenze acquisite** ai colleghi.
...
Materiale didattico riservato — uso interno Tyvak International.
