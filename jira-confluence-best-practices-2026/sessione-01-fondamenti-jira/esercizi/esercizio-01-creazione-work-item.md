...
2. Bug: "Stampante 3° piano non raggiungibile dalla rete" — Priorità: Medium, Etichetta: `hardware`

**💼 Administration & Finance:**
1. Task: "Elaborare ordine forniture Q2 2026" — Priorità: Medium, Etichetta: `acquisti`, Componente: `Procurement`
2. Task: "Verificare fattura fornitore XYZ" — Priorità: High, Etichetta: `fatturazione`

**👥 HR Generalist:**
1. Task: "Preparare kit onboarding ingegnere satellite" — Priorità: High, Etichetta: `onboarding`, Componente: `HR`
